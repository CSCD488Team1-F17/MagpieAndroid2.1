...
public class CollectionAdapter extends RecyclerView.Adapter<CollectionAdapter.CollectionHolder> {
    ...
    /*
     * CollectionHolder inner class below
    **/
...
//            this.rating.setText(currentObject.getRating());
        ...
        void setListeners() {
            ...
            //TODO: implement click of the rest of the card (imgThumb?) to go to that collection page (displaying landmarks)
...
//                    break;
        ...
        // These may never be used, but will allow for easier adding/deletion of collections
        ...
        private void addItem(int position, Collection currentObject) {
